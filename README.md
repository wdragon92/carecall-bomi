...
독거 어르신 대상 **AI 안부 상담** 웹 데모. AI 상담원 **'보미'**가 먼저 안부를 여쭙고 채팅하듯 대화하며,
...
| CLOVA OCR | ✅ 실연동 확인 | General 도메인 신규 APIGW 연동(2026-07-07). 실 이미지→한글 추출→문서 카드 전 구간 검증. ⚠️ 서버 `.env` 재업로드 전까지 프로덕션은 mock 폴백 |
